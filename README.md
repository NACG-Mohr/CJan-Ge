...
|5|[**ATdos**](http://github.com/nacglalevin/ATdos)|使用 `Javascript` 实现前端防御 `http劫持` 及防御 `XSS攻击`，并且对可疑攻击进行上报。|[![](https://img.shields.io/badge/NACG_CJanGe-ATdos-yellow)](http://github.com/nacglalevin/ATdos)|
